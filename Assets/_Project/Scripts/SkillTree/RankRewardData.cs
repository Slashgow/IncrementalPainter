...
public class RankRewardData
{
    ...
    [SerializeField, Range(0, 10000)] private int sRankCurrency = 1000;

    [Tooltip("Bonus currency for A rank")]
    [SerializeField, Range(0, 10000)] private int aRankCurrency = 500;

    [Tooltip("Bonus currency for B rank")]
    [SerializeField, Range(0, 10000)] private int bRankCurrency = 250;

    [Tooltip("Bonus currency for C rank")]
    [SerializeField, Range(0, 10000)] private int cRankCurrency = 100;

    [Tooltip("Bonus currency for D rank")]
    [SerializeField, Range(0, 10000)] private int dRankCurrency = 0;

...
public class UIDayStatsSummary : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI turretDamageValueText;
    [SerializeField] private TextMeshProUGUI mineDamageValueText;
    ...
    private void UpdateDisplay(DayStats stats)
    {
        ...
        turretDamageValueText.text = FormatUtility.FormatValue(stats.TurretDamage);
        mineDamageValueText.text = FormatUtility.FormatValue(stats.MineDamage);

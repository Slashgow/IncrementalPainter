...
namespace PaintIn2D
{
	...
	public class CwPaintDecal2D : MonoBehaviour, IHitPoint, IHitLine, IHitTriangle, IHitQuad, IHitCoord
	{
		...
		public CwBlendMode BlendMode { set { blendMode = value; } get { return blendMode; } } [SerializeField] protected CwBlendMode blendMode = CwBlendMode.AlphaBlend(new Vector4(1.0f, 1.0f, 1.0f, 0.0f));
		...
		public Texture Shape { set { shape = value; } get { return shape; } } [SerializeField] protected Texture shape;

		/// <summary>This allows you specify the texture channel used when sampling <b>Shape</b>.</summary>
		public CwChannel ShapeChannel { set { shapeChannel = value; } get { return shapeChannel; } } [SerializeField] protected CwChannel shapeChannel = CwChannel.Alpha;
		...
		public float Opacity { set { opacity = value; } get { return opacity; } } [Range(0.0f, 1.0f)] [SerializeField] protected float opacity = 1.0f;

		/// <summary>The angle of the texture in degrees.</summary>
		public float Angle { set { angle = value; } get { return angle; } } [Range(-180.0f, 180.0f)] [SerializeField] protected float angle;
		...
		public float Radius { set { radius = value; } get { return radius; } } [SerializeField] protected float radius = 0.1f;
		...
		public Texture TileTexture { set { tileTexture = value; } get { return tileTexture; } } [SerializeField] protected Texture tileTexture;

		/// <summary>This allows you to adjust the tiling position + rotation + scale using a <b>Transform</b>.</summary>
		public Transform TileTransform { set { tileTransform = value; } get { return tileTransform; } } [SerializeField] protected Transform tileTransform;

		/// <summary>This allows you to control the triplanar influence.
		/// 0 = No influence.
		/// 1 = Full influence.</summary>
		public float TileOpacity { set { tileOpacity = value; } get { return tileOpacity; } } [UnityEngine.Serialization.FormerlySerializedAs("tileBlend")] [Range(0.0f, 1.0f)] [SerializeField] protected float tileOpacity = 1.0f;

		/// <summary>This allows you to control how quickly the triplanar mapping transitions between the X/Y/Z planes.</summary>
		public float TileTransition { set { tileTransition = value; } get { return tileTransition; } } [Range(1.0f, 200.0f)] [SerializeField] protected float tileTransition = 4.0f;
		...
		public CwModifierList Modifiers { get { if (modifiers == null) modifiers = new CwModifierList(); return modifiers; } } [SerializeField] protected CwModifierList modifiers;
